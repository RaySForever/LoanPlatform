package xyz.raysmen.lp.sms.service.impl;
...
import xyz.raysmen.lp.sms.util.SmsProperties;
    ...
    public void send(String mobile, String... param) {
        try {
            ...
            */
            ...
            httpProfile.setEndpoint(SmsProperties.ENDPOINT_DOMAIN);
             ...
             * 非必要请不要修改这个字段 */
            final String sha256 = "HmacSHA256";
            clientProfile.setSignMethod(sha256);
            ...
            final String prefix = "+86";
            String[] phoneNumberSet = {prefix + mobile};
            ...
            // 输出json格式的字符串回包
            log.info("输出json格式的字符串回包为{}", SendSmsResponse.toJsonString(res));
            ...
            */
            ...
            throw new BusinessException(e, ResponseEnum.TENCENTCLOUD_SMS_ERROR);
        }
    }
}
